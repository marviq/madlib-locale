!function(e){if("object"==typeof exports)module.exports=e();else if("function"==typeof define&&define.amd)define(e);else{var f;"undefined"!=typeof window?f=window:"undefined"!=typeof global?f=global:"undefined"!=typeof self&&(f=self),f.locale=e()}}(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);throw new Error("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
/*!
...
},{"madlib-object-utils":14,"underscore":15}],14:[function(require,module,exports){
...
},{"./generic":17}],17:[function(require,module,exports){
(function() {
  (function(factory) {
    if (typeof exports === "object") {
...
},{"madlib-console":11,"madlib-object-utils":12,"q":21}],18:[function(require,module,exports){
...
},{"./lib/polyglot":20}],20:[function(require,module,exports){
//     (c) 2012 Airbnb, Inc.
//
...
(function(factory) {
  if (typeof exports === "object") {
    return module.exports = factory(require("q"), require("madlib-console"), require("madlib-settings"), require("madlib-object-utils"), require("madlib-xhr"), require("hbsfy/runtime"), require("node-polyglot"), require("moment"), require("accounting"));
  } else if (typeof define === "function" && define.amd) {
    return define(["q", "madlib-console", "madlib-settings", "madlib-object-utils", "madlib-xhr", "hbsfy/runtime", "node-polyglot", "moment", "accounting"], factory);
  }
})(function(Q, console, settings, objectUtils, XHR, Handlebars, Polyglot, Moment, accounting) {
  /**
  ...
  */
  ...
  LocaleManager = (function() {
    ...
    LocaleManager.prototype.localLocation = "./i18n";

    LocaleManager.prototype.initialize = function(locale, localeLocation) {
      var _this = this;
      if (this.initialized === false) {
        ...
        Handlebars.registerHelper("_translate", function(key, interpolation) {
          if (interpolation == null) {
            interpolation = {};
          }
          return _this.translate(key, interpolation);
        });
        Handlebars.registerHelper("_date", function(type, date) {
          return _this.date(type, date);
        });
        Handlebars.registerHelper("_money", function(currency, amount) {
          return _this.money(currency, amount);
        });
        Handlebars.registerHelper("_number", function(number) {
    ...
    LocaleManager.prototype.setLocale = function(locale) {
      ...
      if (this.initialized === true) {
        ...
        if (this.cache[locale] != null) {
          ...
          xhr.call({
            url: "./" + this.localLocation + "/" + locale + ".json",
            type: "json",
            method: "GET"
          }).then(function(data) {
...
},{"accounting":1,"hbsfy/runtime":10,"madlib-console":11,"madlib-object-utils":12,"madlib-settings":13,"madlib-xhr":16,"moment":18,"node-polyglot":19,"q":21}]},{},[22])
(22)
});